      ...
      <main className="relative z-10">
        ...
        <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-20 px-6 max-w-7xl mx-auto text-center">
          <motion.div {...fadeIn} transition={{ duration: 0.8 }} className="space-y-8 max-w-4xl">
            <span className="inline-block py-2 px-6 rounded-2xl bg-white shadow-[inset_2px_2px_4px_rgba(255,255,255,1),inset_-2px_-2px_4px_rgba(0,0,0,0.05),4px_4px_8px_rgba(0,0,0,0.05)] text-sm font-bold tracking-widest uppercase text-slate-500">
          ...
          >
            {['Trust', 'Transparency', 'Innovation', 'Customer Success', 'Long-Term Relationships', 'Quality', 'Execution'].map((value, idx) => (
              <motion.div key={idx} variants={fadeIn}>
                <ClayCard className="py-4 px-8 rounded-2xl bg-white text-lg font-bold text-slate-800">
                  {value}
                </ClayCard>
              </motion.div>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={idx} variants={fadeIn} transition={{ delay: idx * 0.05 }}>
                <ClayCard className="h-full flex flex-col items-center text-center p-6 bg-white hover:scale-[1.02] transition-transform cursor-default">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <motion.div key={idx} variants={fadeIn} transition={{ delay: idx * 0.02 }}>
                  <div className="px-5 py-2.5 bg-slate-100 rounded-2xl border border-white shadow-sm font-bold text-slate-700 text-sm hover:bg-slate-200 transition-colors cursor-default">
                    {service}
                  </div>
                </motion.div>
              ))}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <a href="https://www.instagram.com/biznxt_online" target="_blank" rel="noopener noreferrer" className="block group">
                <ClayCard className="bg-white flex flex-col items-center text-center group-hover:scale-[1.02] transition-transform h-full">
                  <div className="w-10 h-10 bg-slate-900 text-white rounded-2xl flex items-center justify-center mb-4">
